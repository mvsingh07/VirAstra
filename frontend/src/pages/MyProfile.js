...
<div>
  ...
  <section className="hero-section">
      ...
      <div className="hs-item set-bg"  style={{background: 'url(./assets/img/unsplash.jpg) center center / cover no-repeat',width: '100%',height: '150vh', }}>
        ...
        <div className="container">
            <div className="row">
               ...
               <h1>Isometric Adhyatama Sustenance</h1>
                <a href="/Profile" className="primary-btn my-profile"> My Profile</a>
                </div>
                </div>
              </div>
            </div>
        ...
        <div className="flip-box">
          ...
          <div className="flip-box-back text-center" style={{background: 'url(./images/iso_2.jpg)center center / cover no-repeat'}}>
            <div className="inner color-white">
              <h3 className="flip-box-header">ISOMETRIC</h3>
              <p>Take care of your body, its the only place your soul has to live In.</p>
        ...
        <div className="flip-box">
          ...
          <div className="flip-box-back text-center" style={{background: 'url(./images/adh_2.jpg)center center / cover no-repeat'}}>
            <div className="inner color-white">
              <h3 className="flip-box-header">ADHYATAMA</h3>
              <p>Connect to your inner self to explore whats out there.</p>
        ...
        <div className="flip-box">
          ...
          <div className="flip-box-back text-center" style={{background: 'url(./images/diet_2.jpg)center center / cover no-repeat'}}>
            <div className="inner color-white">
              <h3 className="flip-box-header">SUSTENANCE</h3>
              <p>Our behaviour and our body is influent by what we eat, choose wisely.</p>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="team-title">
                        ...
                        <a href="/MyProfile" class="primary-btn btn-normal appoinment-btn">appointment</a>
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="fs-about">
                        <div class="fa-logo">
                            <a href="/MyProfile"><img src="/assets/img/IASLogo-white.png" alt="error_in_loading"/></a>
                        </div>
                        ...
                        <div class="fa-social">
                            <a href="/MyProfile"><i class="fab fa-facebook-f"></i></a>
                            <a href="/MyProfile"><i class="fab fa-twitter"></i></a>
                            <a href="/MyProfile"><i class="fab fa-youtube"></i></a>
                            <a href="/MyProfile"><i class="fab fa-instagram"></i></a>
                            <a href="/MyProfile"><i class="fab fa-whatsapp"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="fs-widget">
                        ...
                        <ul>
                            ...
                            <li><a href="/MyProfile">Classes</a></li>
                            <li><a href="/MyProfile">Contact</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="fs-widget">
                        ...
                        <ul>
                            ...
                            <li><a href="/MyProfile">Subscribe</a></li>
                            <li><a href="/MyProfile">Contact</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="fs-widget">
                        <h4>Tips & Guides</h4>
                        <div class="fw-recent">
                            <h6><a href="/MyProfile">Physical fitness may help prevent depression, anxiety</a></h6>
                            <ul>
                                <li>3 min read</li>
                                <li>20 Comment</li>
                            </ul>
                        ...
                        <div class="fw-recent">
                            <h6><a href="/MyProfile">Fitness: The best exercise to lose belly fat and tone up...</a></h6>
                            <ul>
                                <li>3 min read</li>
                                <li>20 Comment</li>
                            </ul>
